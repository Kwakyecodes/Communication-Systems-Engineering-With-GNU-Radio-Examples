...
class ACARS_2_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.my_taps = my_taps = firdes.low_pass(1.0, samp_rate, 72e3, 25e3, window.WIN_HAMMING, 6.76)
        self.N = N = 10
        ...
        self._threshold_line_edit.editingFinished.connect(
            lambda: self.set_threshold(int(str(self._threshold_line_edit.text()))))
        ...
        self.iio_pluto_source_0.set_frequency(int(131.725e6))
        ...
        self.analog_am_demod_cf_1 = analog.am_demod_cf(
        	channel_rate=((samp_rate * 6)/N/5),
        	audio_decim=(int(N/2)),
        	audio_pass=5000,
        	audio_stop=5500,
        )
        self.acars_acars_1 = acars.acars(threshold, '/tmp/log1', False)
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.analog_am_demod_cf_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_my_taps(firdes.low_pass(1.0, self.samp_rate, 72e3, 25e3, window.WIN_HAMMING, 6.76))
        self.iio_pluto_source_0.set_samplerate(int(self.samp_rate))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 72e3, 25e3, window.WIN_HAMMING, 6.76))
    ...
    def set_threshold(self, threshold):
        ...
        Qt.QMetaObject.invokeMethod(self._threshold_line_edit, "setText", Qt.Q_ARG("QString", str(self.threshold)))
        self.acars_acars_1.set_seuil(self.threshold)

    def get_my_taps(self):
        return self.my_taps

    def set_my_taps(self, my_taps):
        self.my_taps = my_taps
