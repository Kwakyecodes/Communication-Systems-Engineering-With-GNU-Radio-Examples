...
# Title: Detection of two targets whose time-delayed copies are summed...
...
class detection_two_targets_cross_corr_4_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Detection of two targets whose time-delayed copies are summed...", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Detection of two targets whose time-delayed copies are summed...")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "detection_two_targets_cross_corr_4_2")
        ...
        self._D1_range = qtgui.Range(0, 100, 1, 50, 200)
        self._D1_win = qtgui.RangeWidget(self._D1_range, self.set_D1, "'D1'", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=detection_two_targets_cross_corr_4_2, options=None):
