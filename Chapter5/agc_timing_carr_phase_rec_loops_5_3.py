...
# Title: AGC, timing, and carrier phase recovery loops
...
class agc_timing_carr_phase_rec_loops_5_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AGC, timing, and carrier phase recovery loops", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AGC, timing, and carrier phase recovery loops")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "agc_timing_carr_phase_rec_loops_5_3")
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            256, #size
            samp_rate, #samp_rate
            "Received signal after AGC", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_const_sink_x_1 = qtgui.const_sink_c(
            1024, #size
            "AGC, timing and phase recovery", #name
            1, #number of inputs
            None # parent
        )
...
def main(top_block_cls=agc_timing_carr_phase_rec_loops_5_3, options=None):
