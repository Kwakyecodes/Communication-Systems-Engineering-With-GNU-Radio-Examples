...
# Title: GRC QPSK modulator with hierarchical block.
...
class qpsk_mod_hier_block_5_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GRC QPSK modulator with hierarchical block.", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GRC QPSK modulator with hierarchical block.")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_mod_hier_block_5_2")
        ...
        self.noise_level = noise_level = 1
        ...
        self._noise_level_range = qtgui.Range(0, 10, 0.1, 1, 200)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 255, int(10e3)))), True)
...
def main(top_block_cls=qpsk_mod_hier_block_5_2, options=None):
