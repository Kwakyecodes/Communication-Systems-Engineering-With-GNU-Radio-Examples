...
# Title: QPSK demodulation and data saving
...
class qpsk_demon_data_saving_5_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QPSK demodulation and data saving", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QPSK demodulation and data saving")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_demon_data_saving_5_3")
        ...
        self.my_const = my_const = digital.constellation_qpsk().base()
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/Users/emmanuelkwakyenyantakyi/Desktop/Documents/College/SDR_2026_27/GNU_SDR_Intro/Chapter5/qpsk_msg_rec_bits', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/Users/emmanuelkwakyenyantakyi/Desktop/Documents/College/SDR_2026_27/GNU_SDR_Intro/Chapter5/qpsk_msg_rec_symb', False)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_file_sink_0_0, 0))
...
def main(top_block_cls=qpsk_demon_data_saving_5_3, options=None):
